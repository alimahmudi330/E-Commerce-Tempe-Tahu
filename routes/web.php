...
Route::get('/products/{product}', [CrudController::class, 'show'])->name('products.show');
...
Route::delete('/products/{product}', [CrudController::class, 'destroy'])->name('products.destroy');