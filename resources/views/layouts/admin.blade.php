...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="#" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Tempe Budhe</span>
            </a>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Ali Mahmudi</span></strong>. All Rights Reserved
        </div>
    ...
    <script src="{{ asset('admin/assets/vendor/chart./chart.umd.js') }}"></script>
